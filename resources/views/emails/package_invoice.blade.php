...
<body>
    <section style="padding: 0;width: 100%;margin-right: auto;margin-left: auto;">
        <div style="position: relative;">
                            ...
                            <div style="flex: 0 0 100%;max-width: 100%;">
                                <div class="d-flex my-4" style="justify-content: space-between;">
                                    <div class="" style="flex: 0 50%;width: 50%; margin-top:2rem;" >
                                        ...
                                        <h4 class="p-color">{{ $package?->patient_id ?? '--'}}</h4>
                                    </div>
                                    <div class="" style="flex: 0 50%;width: 50%; margin-top:2rem;" >
                                        <h4 class="h5-title">Patient Name</h4>
                                        <h4 class="p-color">{{ $package?->patient?->name ?? '--'}}</h4>
                                    </div>                                                                  
                                </div>
                                <div class="d-flex my-4" style="justify-content: space-between;">
                                    <div class="" style="flex: 0 50%;width: 50%; margin-top:2rem;" > 
                                        <h4 class="h5-title">National Id</h4>
                                        <h4 class="p-color">{{ $package?->patient?->national_id ?? '--'}}</h4>
                                    </div>
                                    <div class="" style="flex: 0 50%;width: 50%; margin-top:2rem;" >
                                        <h4 class="h5-title">Clinic Name</h4>
                                        <h4 class="p-color">{{ $package?->doctor?->category?->name_en ?? '--'}}</h4>
                                    </div>                                                                
                                </div>
                            </div>
                        ...
                        <div style="flex: 0 0 100%;max-width: 100%;">
                            <div class="d-flex" style="justify-content: space-between;">
                                <div class="" style="flex: 0 0 37.333%;width: 37.333%;margin-top:3.5rem;" > 
                                    ...
                                    <h4 class="p-color">{{ $package?->doctor?->name_en ?? '--'}}</h4>
                                </div>
                                <div class="" style="flex: 0 0 33.333%;width: 33.333%;margin-top:3.5rem;" >
                                    <h4 class="h5-title">Package No</h4>
                                    <h4 class="p-color">{{ $package?->id ?? '--'}}</h4>
                                </div>                                                                
                                <div class="" style="flex: 0 0 33.333%;width: 33.333%;margin-top:3.5rem;" >
                                    <h4 class="h5-title">Expire Date & Time </h4>
                                    <h4 class="p-color">{{ Carbon\Carbon::parse($package->expired_at)->format('d M Y g:i a') ?? '--'}}</h4>
                                </div>                                                                
                            </div>
                    ...
                    <div class="w-100">
                        <div style="flex: 0 0 100%;max-width: 100%;">
                            <div class="d-flex mb-2" style="justify-content: space-between;">                                                                                           
                                <div class="" style="flex: 0 70%;width: 70.333%;margin-top:3.5rem;" >
                                    <h4 class="h5-title">Purchased At</h4>
                                    <h4 class="p-color">{{ Carbon\Carbon::parse($package->created_at)->format('d M Y g:i a') ?? '--'}}</h4>
                                </div>                                                                
                            </div>
            ...
            @php
                $price = addAppCommission(number_format($package->price,2));
                $vat = calculateVATtax($package?->patient?->national_id,(float)$price);
                $dicount = calculateDiscount($package?->promocode?->percent,$price);
                $total = $price + $vat + $dicount;
            @endphp

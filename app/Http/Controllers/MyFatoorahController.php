...
class MyFatoorahController extends Controller
{
    ...
    public function __construct(public PaymentMyfatoorahApiV2 $mfObj)
    {
    }
    ...
    public function index()
    {
      try {
            ...
            $curlData = $this->getPayLoadData(Transaction::inRandomOrder()->value('id'));
...
//-----------------------------------------------------------------------------------------------------------------------------------------
    ...
    private function getPayLoadData($orderId = null)
    {
        ...
        return [
            ...
            'SourceInfo' => 'Laravel  MyFatoorah Package '
        ];
    }

            ...
            <form method="POST" action="{{ route('admin.roles.store') }}">
                ...
                <table class="table table-striped">
                    ...
                    @foreach($permissions as $parent=>$children)
                            ...
                            <tr>
                                <th class="pl-md-4" width="1%"><input type="checkbox" data-title="{{$parent}}" class="grouped_permission" name="grouped_permission"></th>
                            ...
                            @foreach($children as $child)
                                <tr>
                                    <td class="pl-md-5">
                                        ...
                                        value="{{ $child->name }}"
                                        class='permission {{$parent."_permission"}} grouped_permission'
                                        >
                                    </td>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('[name="all_permission"]').on('click', function() {
                ...
                if($(this).is(':checked')) {
                    $.each($('.grouped_permission'), function() {
